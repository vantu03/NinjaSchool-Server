...
public class TruongLangChai implements INpcHandler {
    ...
    public void openMenu(Player player, PlayerTemplate playerTemplate) {
        ...
        if (player.taskMain == null && (player.getTaskFinish() == 17 || player.getTaskFinish() == 18 || player.getTaskFinish() == 19 || player.getTaskFinish() == 20)) {
        ...
        } else if (player.taskMain != null && player.taskMain.index >= player.taskMain.template.subNames[player.getSession().typeLanguage].length - 1 && (player.getTaskFinish() == 17 || player.getTaskFinish() == 18 || player.getTaskFinish() == 19 || player.getTaskFinish() == 20)) {
